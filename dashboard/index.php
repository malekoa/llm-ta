...
$router->post("/vote", "DashboardController@submitVote");
$router->get("/feedback", "DashboardController@feedbackView");
$router->post("/feedback", "DashboardController@submitVote");
